...
<Note>
Status: render_ui-Bausteine, der Sektion-Vertrag UND die Beitrags-Verdrahtung (`collectHomeSections` → Composer) sind **live**. Eingebaute Sektionen (Briefing · JETZT · Heute · Für dich · Filmabend) registriert die App selbst; Dritt-Plugins docken über denselben `homeSections`-Vertrag an.
</Note>
