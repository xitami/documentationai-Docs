...
<Note>
Die render_ui-Bausteine und der Sektion-Vertrag sind **live**. Die App registriert heute die eingebauten Sektionen (Briefing · JETZT · Heute · Für dich · Filmabend). Das Beisteuern eigener Sektionen durch Dritt-Plugins über `contributes.homeSections[]` wird gerade verdrahtet — der Vertrag oben ist bereits die Zielform.
</Note>
