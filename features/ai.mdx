...
title: KI-Features
description: >-
  KI-Assistent, Embeddings, Vision, Audio-Transkription, tägliches Briefing und
...
Du kannst relevante Inhalte oder Entitäten gezielt pinnen und später wieder entpinnen. Gepinnte Elemente wirken wie ein bewusst gesetzter Fokus: Der Assistent berücksichtigt sie als zusätzlichen Kontext für Antworten, Zusammenfassungen und nächste Schritte, ohne dass du dieselben Informationen in jeder Anfrage erneut beschreiben musst.
